...
// Nested function can access the variable internal because it can access other local functions, variables, constants, types, and classes inside the function.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    const zooAnimals = data.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(){
    const totalPopulation = zooAnimals.filter(function(item){
...
function greeting(Jane, Doe){
   return `Hello ${Jane} ${Doe}, nice to meet you!`;
  }
console.log(consume("Jane", "Doe", greeting));
...
CuboidMaker.prototype.surfaceArea = function(){
  return (surfaceArea(length, width, height));{
    CuboidMaker * (length * width + length * height + width * height);
  }
